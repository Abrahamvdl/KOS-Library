...
until true = false {
  ...
  set EccenVecApproc to (myOrbit:POSITION - myOrbit:VELOCITY:ORBIT):NORMALIZED * myOrbit:SemiMajorAXIS.

  set TrueAnomalyCalc to arccos(vdot(EccenVecApproc, myOrbit:POSITION)/(EccenVecApproc:MAG * myOrbit:POSITION:MAG)).
