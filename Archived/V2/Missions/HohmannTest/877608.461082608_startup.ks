...
function SecantSolver {
  ...
  local q0 is Equation(p1,p0,eccentricity).
  local q1 is Equation(p1,p1,eccentricity).
    ...
    until counter >= maxN {
        ...
        set q0 to q1.
        set p1 to p.
        set q1 to Equation(MeanAnomoaly, p1, eccentricity).
		}
...
until true = false {
  ...
  set EccentricSolver to SecantSolver(MeanAnomoalyC + 20, MeanAnomoaly, 50, 0.1, myOrbit:ECCENTRICITY, EccentricAnomaly ).
