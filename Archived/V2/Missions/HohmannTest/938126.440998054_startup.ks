...
until true = false {
	...
	if myOrbit:ETA:Periapsis < 1 and not PosSet {
		...
		set TargetTrueAnomaly to mod(CurrentTrueAnomaly + CurrentAngleDiff, 360).
		set PosSet to true.
	...
	if PosSet {
		...
		print "Initial Angle Diff: " + CurrentAngleDiff.
		print "Initial TrueAnomaly: " + CurrentTrueAnomaly.
		print "TargetTrueAnomaly: " + TargetTrueAnomaly.
