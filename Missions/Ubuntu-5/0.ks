...
if SHIP:STATUS = "FLYING" {
	...
	// wait until(altitude > 8800).
	
	set pitch_ang to 90.
	lock steering to heading(90,pitch_ang).

	set targetHeight to 71000.
	...
	set throttleController to ThrottleControl(40000, 20).
	...
	until altitude > targetHeight{
		...
		print "Throtle Val: " + round(throttle, 2) at (0,20).
