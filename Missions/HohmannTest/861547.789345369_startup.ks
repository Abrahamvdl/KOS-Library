...
until true = false {
  ...
  print "OUR ORBIT Periapsis ETA: " + OBT:ETA:Periapsis.
  print "OUR ORBIT PERIOD: " + OBT:PERIOD.
  set MeanTrueAnomalyCalc to (OBT:PERIOD - OBT:ETA:PERIAPSIS) / OBT:PERIOD * 360.
  print "Calculated TrueAnomaly: " + MeanTrueAnomalyCalc.
  print "ACTUAL TRUEANOMALY: " + OBT:TrueAnomaly.
