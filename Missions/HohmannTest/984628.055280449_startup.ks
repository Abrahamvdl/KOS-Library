...
//		if HasMaxDist and currentDistance < minDistance{
	...
	SET anArrow1 TO VECDRAW(Kerbin:position, Kerbin:position - myOrbit:POSITION, RGB(1,0,0), "Arrow 1", 1.0, TRUE, 0.2, TRUE,	TRUE ).
	...
	SET anArrow4 TO VECDRAW(kerbin:position, Kerbin:position - ship:position , RGB(1,1,1), "Arrow 4", 1.0, TRUE, 0.2, TRUE,	TRUE ).
