...
until true = false {
  ...
  set TrueAnomalyCalc to arccos(vdot(EccenVec, myOrbit:POSITION)/(EccenVec:MAG * myOrbit:POSITION:MAG)).
  ...
  set vdx TO VECDRAW(Kerbin:position, AOPVecX * myOrbit:PERIAPSIS , RGB(0,1,0), "RotatedVec", 1.0, TRUE, 0.2, TRUE,	TRUE ).
