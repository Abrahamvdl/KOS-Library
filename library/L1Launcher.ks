//Launcher of Level 1 rockets.
//It uses the following first stage 4 boosters feeding into a central booster all firing, and then in the upper atmosphere, the 
//four boosters are jetisoned, and the orbit is cirularized at around 80km with about a 3rd of the fuel remaining in the main booster.
